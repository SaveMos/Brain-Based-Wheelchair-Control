...
class LabelReceived:
    """
    Data Object class to represent a Label as received from the Ingestion and Production Systems.
    """

    def __init__(self, uuid: str, movements: int):
        """
        Initialize the LabelReceived with uuid and movements fields.
